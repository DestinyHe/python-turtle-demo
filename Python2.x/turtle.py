...
_ver = "turtle 1.1b - for Python 2.7   -  15. 6. 2009, 19:55"
...
_tg_turtle_functions = ['back', 'backward', 'begin_fill', 'begin_poly', 'bk',
        ...
        'degrees', 'distance', 'dot', 'down', 'end_fill', 'end_poly', 'fd', 'fill', 'filling',
...
,
    ...
    def tiltangle(self, angle=None):
        ...
        Deprecated since Python 2.7 / 3.1
